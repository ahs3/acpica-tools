...
DefinitionBlock ("grammar.aml", "DSDT", 1, "Intel", "GRMTEST", 0x20090511)
{
    ...
    Device (CMB1)
    {
        ...
        Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
        {
            ...
            Index (RBIF, One) = B1DC /* \B1DC */
            Index (RBIF, 0x02) = B1LF /* \B1LF */
            Index (RBIF, 0x09) = "CA54200-5003/5"
            Index (RBIF, 0x0A) = "1"
            Return (RBIF) /* \RBIF */
        }
    ...
    Method (FLDS, 0, Serialized)
    {
        ...
        Else
        {
            Local0 = DerefOf (Index (BUF2, Zero))
            If ((Local0 != 0x08))
            {
                ERR (One)
            }
    ...
    Method (REFS, 0, Serialized)
    {
        ...
        Local6 = DerefOf (Index (BBUF, 0x03))
        If ((Local6 != 0xB3))
        {
            ERR (0x02)
        }

        Local0 = DerefOf (Index (DerefOf (Index (NEST, One)), 0x03))
        If ((Local0 != 0x14))
        {
            ERR (0x02)
        }
    ...
    Scope (_TZ)
    {
        ...
        Device (C19B)
        {
            ...
            Method (XINI, 0, NotSerialized)
            {
                ...
                C18E = DerefOf (Index (DerefOf (Index (C18C, C19A)), One))
                C18F = DerefOf (Index (DerefOf (Index (C18C, C19A)), 0x02))
                RSLT = One
            }
        }
    ...
    Device (DVAX)
    {
        Method (TEST, 0, NotSerialized)
        {
            ...
            B1LO = 0x19
            B1HI = Zero
            Divide (((0x03 * MKW (B1LO, B1HI)) + 0x63), 0x64, Local4, 
                Local2)
    ...
    Scope (_SB)
    {
        ...
        Device (IDX0)
        {
            ...
            Method (_BIF, 0, Serialized)  // _BIF: Battery Information
            {
                ...
                Index (BUFR, Zero) = ^^PCI2.ISA.EC0.BPU0 /* \_SB_.PCI2.ISA_.EC0_.BPU0 */
                Index (BUFR, One) = ^^PCI2.ISA.EC0.BDC0 /* \_SB_.PCI2.ISA_.EC0_.BDC0 */
                Index (BUFR, 0x02) = ^^PCI2.ISA.EC0.BFC0 /* \_SB_.PCI2.ISA_.EC0_.BFC0 */
                Index (BUFR, 0x03) = ^^PCI2.ISA.EC0.BTC0 /* \_SB_.PCI2.ISA_.EC0_.BTC0 */
                Index (BUFR, 0x04) = ^^PCI2.ISA.EC0.BDV0 /* \_SB_.PCI2.ISA_.EC0_.BDV0 */
                Index (BUFR, 0x05) = ^^PCI2.ISA.EC0.BCW0 /* \_SB_.PCI2.ISA_.EC0_.BCW0 */
                Index (BUFR, 0x06) = ^^PCI2.ISA.EC0.BCL0 /* \_SB_.PCI2.ISA_.EC0_.BCL0 */
                Index (BUFR, 0x07) = ^^PCI2.ISA.EC0.BCG0 /* \_SB_.PCI2.ISA_.EC0_.BCG0 */
                Index (BUFR, 0x08) = ^^PCI2.ISA.EC0.BG20 /* \_SB_.PCI2.ISA_.EC0_.BG20 */
                Index (BUFR, 0x09) = ""
                Index (BUFR, 0x0A) = ""
                Index (BUFR, 0x0B) = "LiOn"
                Index (BUFR, 0x0C) = "Chicony"
            ...
            Method (TEST, 0, Serialized)
            {
                ...
                Index (PBUF, Zero) = 0x01234567
                Index (PBUF, One) = 0x89ABCDEF
                Index (PBUF, 0x02) = 0xFEDCBA98
                Index (PBUF, 0x03) = 0x76543210
                If ((DerefOf (Index (PBUF, Zero)) != 0x01234567))
                {
                    Return (0x10)
                }

                If ((DerefOf (Index (PBUF, One)) != 0x89ABCDEF))
                {
                    Return (0x11)
                }

                If ((DerefOf (Index (PBUF, 0x02)) != 0xFEDCBA98))
                {
                    Return (0x12)
                }

                If ((DerefOf (Index (PBUF, 0x03)) != 0x76543210))
                {
                    Return (0x13)
                }
                ...
                Index (BUFR, Zero) = 0x01234567
                Index (BUFR, 0x04) = 0x89ABCDEF
                Index (BUFR, 0x08) = 0xFEDCBA98
                Index (BUFR, 0x0C) = 0x76543210
                If ((DerefOf (Index (BUFR, Zero)) != 0x67))
                {
                    Return (0x30)
                }

                If ((DerefOf (Index (BUFR, One)) != Zero))
                {
                    Return (0x31)
                }

                If ((DerefOf (Index (BUFR, 0x04)) != 0xEF))
                {
                    Return (0x34)
                }

                If ((DerefOf (Index (BUFR, 0x08)) != 0x98))
                {
                    Return (0x38)
                }

                If ((DerefOf (Index (BUFR, 0x0C)) != 0x10))
                {
                    Return (0x3C)
                }
    ...
    Scope (_SB)
    {
        ...
        Method (C17B, 1, Serialized)
        {
            ...
            Local0 = (Arg0 & 0x07)
            Local4 = (Local0 >> One)
            Index (C178, Local4) = C179 /* \_SB_.C179 */
            Index (C179, 0x02) = 0x1234
            Local2 = DerefOf (Index (C179, 0x02))
            If ((Local2 != 0x1234))
            {
                Return (0x1234)
            }

            Local2 = DerefOf (Index (DerefOf (Index (C178, Zero)), 0x02))
            If ((Local2 != 0x966B))
            {
                Return (0x1234)
            }

            Index (C179, 0x02) = 0x966B
            Index (DerefOf (Index (C178, Zero)), 0x03) = 0x5678
            Local2 = DerefOf (Index (DerefOf (Index (C178, Zero)), 0x03))
            If ((Local2 != 0x5678))
            {
                Return (0x5678)
            }

            Local2 = DerefOf (Index (C179, 0x03))
            If ((Local2 != 0x4190))
            {
                Return (0x5678)
            }

            Index (DerefOf (Index (C178, Zero)), 0x03) = 0x4190
        ...
        Device (IDX3)
        {
            Method (LCLB, 0, Serialized)
            {
                ...
                While ((Local0 < 0x05))
                {
                    Local2 = DerefOf (Index (Local1, Local0))
                    Local3 = ObjectType (Local2)
                    If ((Local3 != One))
                    {
                        Return (0x9E)
    ...
    Device (IDX7)
    {
        ...
        Method (TST2, 0, Serialized)
        {
            ...
            Index (BUF0, 0x02) = 0x55
            Local0 = DerefOf (Index (BUF0, 0x02))
            If ((Local0 == 0x55))
            {
                Return (Zero)
            }
        ...
        {
            Local0 = DerefOf (Index (PKG4, Zero))
            If ((Local0 == 0x02))
            {
                Return (Zero)
            }
        ...
        {
            Local0 = DerefOf (Index (PKG4, 0x02))
            Local1 = SizeOf (Local0)
            If ((Local1 == 0x04))
            {
                Return (Zero)
        ...
        {
            Local0 = DerefOf (Index (PKG4, 0x03))
            If ((Local0 == 0x1234))
            {
                Return (Zero)
            }
        ...
        {
            Local0 = DerefOf (Index (PKG4, 0x04))
            Local1 = SizeOf (Local0)
            If ((Local1 == 0x02))
            {
                Return (Zero)
        ...
        Method (TSTF, 0, Serialized)
        {
            ...
            Index (DEST, 0x02) = SRCB /* \IDX7.TSTF.SRCB */
            Local0 = DerefOf (Index (DEST, 0x02))
            If ((Local0 != 0x72))
            {
        ...
        Method (TSTG, 0, Serialized)
        {
            ...
            Index (DEST, 0x02) = SRCB /* \IDX7.TSTG.SRCB */
            Local0 = DerefOf (Index (DEST, 0x03))
            If ((Local0 != 0x74))
            {
                Return ((Local0 | 0x2000))
            }

            Local0 = DerefOf (Index (DEST, 0x04))
            If ((Local0 != 0x69))
            {
                Return ((Local0 | 0x2100))
            }

            Local0 = DerefOf (Index (DEST, 0x05))
            If ((Local0 != 0x6E))
            {
                Return ((Local0 | 0x2200))
            }

            Local0 = DerefOf (Index (DEST, 0x06))
            If ((Local0 != 0x61))
            {
                Return ((Local0 | 0x2300))
            }

            Local0 = DerefOf (Index (DEST, 0x07))
            If ((Local0 != 0x74))
            {
                Return ((Local0 | 0x2400))
            }

            Local0 = DerefOf (Index (DEST, 0x0E))
            If ((Local0 != 0x66))
            {
                Return ((Local0 | 0x2400))
            }
        ...
        Method (TSTH, 0, Serialized)
        {
            ...
            Index (DBUF, 0x02) = 0x12345678
            Local0 = DerefOf (Index (DBUF, 0x02))
            If ((Local0 != 0x78))
            {
                Return ((Local0 | 0x3000))
            }

            Local0 = DerefOf (Index (DBUF, 0x03))
            If ((Local0 != 0x64))
            {
                Return ((Local0 | 0x3100))
            }

            Local0 = DerefOf (Index (DBUF, 0x04))
            If ((Local0 != 0x65))
            {
                Return ((Local0 | 0x3200))
            }

            Local0 = DerefOf (Index (DBUF, 0x05))
            If ((Local0 != 0x66))
            {
    ...
    Scope (_SB)
    {
        ...
        Device (BAT1)
        {
            ...
            Method (_BIF, 0, Serialized)  // _BIF: Battery Information
            {
                ...
                Index (BUFR, One) = ^^MEM.BDC1 /* \_SB_.MEM_.BDC1 */
                Index (BUFR, 0x02) = ^^MEM.BLF1 /* \_SB_.MEM_.BLF1 */
                Index (BUFR, 0x03) = ^^MEM.BTC1 /* \_SB_.MEM_.BTC1 */
                Index (BUFR, 0x04) = ^^MEM.BDV1 /* \_SB_.MEM_.BDV1 */
                Index (BUFR, 0x05) = ^^MEM.BCW1 /* \_SB_.MEM_.BCW1 */
                Index (BUFR, 0x06) = ^^MEM.BCL1 /* \_SB_.MEM_.BCL1 */
                Index (BUFR, 0x07) = ^^MEM.BG11 /* \_SB_.MEM_.BG11 */
                Index (BUFR, 0x08) = ^^MEM.BG21 /* \_SB_.MEM_.BG21 */
                Index (BUFR, 0x09) = ^^MEM.BMN1 /* \_SB_.MEM_.BMN1 */
                Index (BUFR, 0x0A) = ^^MEM.BSN1 /* \_SB_.MEM_.BSN1 */
                Index (BUFR, 0x0B) = ^^MEM.BTP1 /* \_SB_.MEM_.BTP1 */
                Index (BUFR, 0x0C) = ^^MEM.BOI1 /* \_SB_.MEM_.BOI1 */
        ...
        Device (IDX2)
        {
            Method (B2IB, 0, Serialized)
            {
                ...
                Index (DEST, 0x02) = SRCB /* \_SB_.IDX2.B2IB.SRCB */
                Local0 = DerefOf (Index (DEST, 0x03))
                If ((Local0 != 0x74))
                {
                    If ((Local0 == 0x68))
                ...
                Local0 = DerefOf (Index (SRCB, 0x02))
                If ((Local0 != 0x6F))
                {
                    If ((Local0 == 0x6B))
                    {
                ...
                Local0 = DerefOf (Index (DEST, 0x0A))
                If ((Local0 != 0x6E))
                {
                    Return (0x83)
                }
            ...
            Method (FB2P, 0, Serialized)
            {
                ...
                ^^MEM.SMD2 = 0xFEDCBA98
                ^^MEM.SMD3 = 0x76543210
                Index (DEST, Zero) = ^^MEM.SME0 /* \_SB_.MEM_.SME0 */
                Index (DEST, One) = ^^MEM.SME1 /* \_SB_.MEM_.SME1 */
                Local0 = DerefOf (Index (DEST, Zero))
                Local1 = DerefOf (Index (DEST, One))
                Local2 = ObjectType (Local0)
                If ((Local2 != 0x03))
                {
                    Return (0x11)
                ...
                Local4 = DerefOf (Index (DerefOf (Index (DEST, Zero)), Zero))
                If ((Local4 != 0x67))
                {
                    Return (0x13)
                }

                Local4 = DerefOf (Index (DerefOf (Index (DEST, Zero)), One))
                If ((Local4 != 0x45))
                {
                    Return (0x14)
                }

                Local4 = DerefOf (Index (DerefOf (Index (DEST, Zero)), 0x04))
                If ((Local4 != 0xEF))
                {
                    Return (0x15)
                }

                Local4 = DerefOf (Index (DerefOf (Index (DEST, Zero)), 0x05))
                If ((Local4 != 0xCD))
                {
                    Return (0x16)
                }
                ...
                ^^MEM.SMD0 = 0x12345678
                Local5 = DerefOf (Index (DerefOf (Index (DEST, Zero)), Zero))
                If ((Local5 != 0x67))
                {
                    Return (0x21)
                }

                Local5 = DerefOf (Index (DerefOf (Index (DEST, Zero)), One))
                If ((Local5 != 0x45))
                {
                    Return (0x22)
                }

                Index (DerefOf (Index (DEST, Zero)), Zero) = 0x30
                Local5 = DerefOf (Index (DerefOf (Index (DEST, Zero)), Zero))
                If ((Local5 != 0x30))
                {
                    Return (0x23)
    ...
    Device (SIZO)
    {
        ...
        Method (SARG, 0, Serialized)
        {
            ...
            Index (BUF1, 0x02) = 0x55
            Local0 = SAR0 (Index (PKG1, Zero), 0x0C)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x28)
            ...
            Local0 = SAR0 (Index (PKG1, One), 0x07)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x29)
            ...
            Local0 = SAR0 (Index (PKG1, 0x02), 0x06)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x2A)
            ...
            Local0 = SAR0 (Index (PKG1, 0x03), 0x04)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x2B)
            ...
            Local0 = SAR0 (Index (PKG2, Zero), 0x0F)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x2B)
            ...
            Local0 = SAR0 (Index (PKG2, One), 0x08)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x2B)
            ...
            Debug = "SizeOf(Arg=Package String Element) PASS"
            Local0 = SAR0 (Index (PKG2, 0x02), 0x02)
            Local1 = ObjectType (Local0)
            If ((Local1 != One))
            {
                Return (0x2B)
